        ...
        <div class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8">
            <div class="grid grid-cols-3 gap-4">
                ...
                <div class="relative mb-4" data-te-input-wrapper-init>
                    ...
                    <InputText type="text" v-model="form.last_name" placeholder="Apellidos" class="w-full rounded" />
                ...
                <div class="relative mb-4" data-te-input-wrapper-init>
                    ...
                    <InputText type="text" v-model="form.phone" placeholder="Teléfono" class="w-full rounded" />
            ...
            <div class="grid grid-cols-2 gap-4">
                <div class="relative mb-6" data-te-input-wrapper-init>
                    ...
                    <Dropdown v-model="form.profile" :options="profiles" optionLabel="name" optionValue="id" placeholder="Selecccione perfil" class="w-full md:w-14rem" />
                    <span v-if="error_profile" class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative" role="alert">{{ error_profile }}</span>
                </div>
                <div class="relative mb-6" data-te-input-wrapper-init>
                    <label for="email">
                        Email
                    </label>
                    <InputText type="text" v-model="form.email" placeholder="Correo" class="w-full rounded" />
                    <span v-if="error_email" class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative" role="alert">{{ error_email }}</span>
                </div>
            </div>
                    ...
                    if (e.response) {
                        switch (e.response.status) {
                            case 422:
                                ...
                                this.error_profile = err.profile ? err.profile[0] : null
